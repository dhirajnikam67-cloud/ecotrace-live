...
export default function EcoTraceEnterpriseDashboard() {
  ...
  const handleAddFactory = (e) => {
    e.preventDefault();
    alert('Factory onboarded to Cloud Registry!');
    setFactoryName('');
    setFactoryLocation('');
          ...
          <div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '20px', marginBottom: '25px' }}>
              ...
              <div style={{ backgroundColor: Number(hazWasteRatio) >= 80 ? '#7c2d12' : '#064e3b', border: '1px solid #334155', padding: '18px', borderRadius: '12px' }}>
                <h3 style={{ margin: '0 0 6px 0', color: '#fff', fontSize: '16px' }}>
                  Hazardous Chemical Waste Radar
                </h3>
          ...
          <div style={{ backgroundColor: '#1e293b', padding: '25px', borderRadius: '12px', border: '1px solid #334155' }}>
            ...
            <form onSubmit={handleAddFactory} style={{ display: 'flex', flexDirection: 'column', gap: '15px', maxWidth: '500px', marginTop: '20px' }}>
              <div>
                ...
                <input required type="text" value={factoryName} onChange={(e) => setFactoryName(e.target.value)} placeholder="e.g. Western Unit" style={{ width: '100%', padding: '10px', borderRadius: '6px', border: '1px solid #334155', backgroundColor: '#0f172a', color: '#fff' }} />
              </div>
              <div>
              ...
              <div>
                <label style={{ display: 'block', fontSize: '13px', color: '#94a3b8', marginBottom: '5px' }}>MPCB Water Consent Limit</label>
          ...
          <div style={{ backgroundColor: '#1e293b', padding: '25px', borderRadius: '12px', border: '1px solid #334155' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '15px', marginTop: '20px' }}>
              <div style={{ borderLeft: '4px solid #ef4444', backgroundColor: '#0f172a', padding: '15px', borderRadius: '6px' }}>
                <h4 style={{ margin: '0 0 5px 0', color: '#fca5a5' }}>Hazardous and Other Wastes Rules</h4>
                <p style={{ margin: 0, fontSize: '13px', color: '#94a3b8' }}>Mandatory disposal through MPCB CHWTSDF facilities.</p>
              </div>
              <div style={{ borderLeft: '4px solid #3b82f6', backgroundColor: '#0f172a', padding: '15px', borderRadius: '6px' }}>
                <h4 style={{ margin: '0 0 5px 0', color: '#93c5fd' }}>The Water Act</h4>
